...
<html>
  ...
  <div class="container">
    ...
    <a href="index.php" style="color: black; ">
      ...
      <div class="inner-container"> 
        ...
        <br><br><br>
          ...
          <h2 style="color:rgb(1, 0, 140);  text-align: center;"><?php echo $department; ?></h2>
         <?php
        ?>
        </div>
    </div>
    <div class="right-container">
      ...
      <?php
         foreach($fields as $field){
          if($field != 'phone number' && $field != 'address' && $field != 'email' && $field != 'age'){ ?>
